...
| End-to-end Procure-to-Pay flow | **Built, not yet deployed.** See Section 3 — this is now the top technical priority. |
...
1. Apply all 9 undeployed migrations to prod Postgres in order, redeploy backend +
   frontend to Cloud Run, per `docs/DEPLOY_CHEATSHEET.md`.
